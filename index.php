...
<body>
	...
	<div id="container">
		...
		<div id="middle_block">
			...
			<div id="social">
				<div class="icon vk"><a href="#"><img src="<?= JUri::base(TRUE) . "/templates/" . $doc->template;?>/img/vk.png" height="50" width="50"></a></div>
				<div class="icon odnoklassniki"><a href="#"><img src="<?= JUri::base(TRUE) . "/templates/" . $doc->template;?>/img/odnoklassniki.png" height="50" width="50"></a></div>
				<div class="icon instagramm"><a href="#"><img src="<?= JUri::base(TRUE) . "/templates/" . $doc->template;?>/img/instagram.png" height="50" width="50"></a></div>
